<table>
    <thead>
    <tr>
        <td style="text-align: center;font-weight: bold;" colspan="7">PRODUCT SALES</td>
    </tr>
    <tr>
        <th style="width:20px">Package Name</th>
        <th style="width:20px">Sold</th>
        <th style="width:20px">Average Rate</th>
        <th style="width:20px">Package Revenue</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ number_format($item['total_product_sales'] ?: 0,0,',','.') }}</td>
            <td>{{ 'Rp. ' . number_format($item['average_rate'] ?: 0,2,',','.') }}</td>
            <td>{{ 'Rp. ' . number_format($item['product_revenue'] ?: 0,2,',','.') }}</td>
...
<table>
    <thead>
    <tr>
        <td style="text-align: center; font-weight: bold;" colspan="8">ALL PACKAGE RESERVATION</td>
    </tr>
    <tr>
