<div id="navigation">
    ...
    <ul class="navigation-menu">
        ...
        <li class="has-submenu">
            <a href="/mahasiswa"><i class="fa fa-users"></i>Mahasiswa</a>
        </li>
        <li class="has-submenu">
            <a href="/setting"><i class="fa fa-gear"></i>Setting</a>
        </li>
        ...
        <li class="has-submenu">
            ...
            <ul class="submenu">
                ...
                <li><a href="/matrix_solusi_ideal">Matrix Solusi Ideal Positif Negatif</a></li>
        ...
        <li class="has-submenu">
            <a href="/hasil_rekomendasi"><i class="fa fa-check"></i>Hasil Rekomendasi</a>
        </li>
