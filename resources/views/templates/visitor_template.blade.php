                    ...
                    <div class="row footer-bg-color">
                        <div class="container footer-bg-height">
                            ...
                            <div class="col-xs-12 col-lg-12" style="text-align: center;">
                                <h4>
                                    <small class="font-primary copyright-footer">Copyright &copy; 2020 <strong><a class="font-primary" href="https://tripasysfo.com/" target="_blank">Tripasysfo Development</a></strong>. All rights reserved.</small>
                                </h4>
                            </div>
                        </div>
                    </div>
