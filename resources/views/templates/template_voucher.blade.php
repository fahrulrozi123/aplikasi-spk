                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top:20px; margin-bottom:20px;">
                        <table  style="width:100%" class="font-voucher fs-14 horison-dark">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:top; border-top: 1px dashed black; border-left: 1px dashed black; padding-left:10px;width:35%"><b>Payment Details</b></td>
                                <td style="vertical-align:top; border-top: 1px dashed black; border-right: 1px dashed black;width:60%"></td>
                            </tr>
                            <tr>
                                <td style="height:4%; vertical-align:top;width:30%"><b>Check In:</b></td>
                                <td style="vertical-align:top;width:35%">{{$data->rsvp_checkin}}</td>
                                <td style="vertical-align:top; border-top: 1px dashed transparent; border-left: 1px dashed black; padding-left:10px;width:35%">Payment Method:</td>
                                <td style="vertical-align:top; border-top: 1px dashed transparent; border-right: 1px dashed black;width:60%">{{$data->payment->payment_type}}</td>
                            </tr>
                            <tr>
                                ...
                                <td style="vertical-align:top; border-bottom: 1px dashed black; border-left: 1px dashed black; padding-left:10px;width:35%">Transferred Date:</td>
                                <td style="vertical-align:top; border-bottom: 1px dashed black; border-right: 1px dashed black;width:60%">{{$data->payment->transaction_time}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:top;width:35%">{{$data->rsvp_breakfast == 1 ? "Yes" : "No"}}</td>
                            </tr>
                            @endif
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <ul class="fs-14">
                                <li class="mb-12 font-voucher horison-dark">Service and Tax are <b>Included in the Price.</b></li>
                                <li class="mb-12 font-voucher horison-dark">All special request are subject to availability upon arrival and any specific additional request made should contact the hotel at the maximum 1 day prior before arrival.</li>
                                @if($data->from == "ROOMS")
                                <li class="mb-12 font-voucher horison-dark">Breakfast are not applied for Guest using Extra Bed(s).</li>
                                <li class="mb-12 font-voucher horison-dark">Check In from 08.00 AM until 14.00 PM, while Check Out at 12.00 PM.</li>
                                <li class="mb-12 font-voucher horison-dark">Guest should contact hotel 1 day prior to arrival or inform for any possible early or late Check In.</li>
                                @endif
                            </ul>
                        </div>
                        <div class="col-md-9">
                            <h4 class="font-voucher horison-dark" style="font-size: 16px;">Cancellation, Refund and Reschedule Policy</h4>
                            <ul class="fs-14">
                                @if($data->from == "ROOMS")
                                <li class="mb-12 font-voucher horison-dark">
                                    Cancellation for booking(s) 4 days prior before Check In will not apply any Cancellation Fee,
                                    while Cancellation that made <b>less than 4 days before Check In</b> will apply Cancellation Fee
                                    before being Refunded.
                                </li>
                                @endif
                                <li class="mb-12 font-voucher horison-dark">Contact our costumer services for cancellation, refund and reschedule possibility.
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <table class="font-voucher fs-11 horison-dark;">
                            ...
                            <tr>
                                <td  style="height: 3%; vertical-align:middle; text-align: center; padding-bottom: 10px;">
                                    <span><img src="{{asset('/images/utility/mail.jpg')}}" width="10" style="margin-right:3px;">{{$setting->email }}
                                    </span>
                                </td>
                                <td style="height: 3%; vertical-align:middle; text-align: center; padding-bottom: 10px;">
