...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <a href="/master_data/package/create" class="btn btn-horison btn-lg pull-right">
                <b>+ UNBOX YOUR PACKAGE</b>
            </a>
            <br>
                            ...
                            <div class="panel-body shadow">
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    @if ($products[$i]->sales_inquiry == 0)
                                        <h4 class="mb"><strong>Package Price :
                                                <script>
                                                    document.write("Rp " + formatRupiah("{{ $products[$i]->product_price }}"));
                                                </script>
                                            </strong></h4>
                                    @endif
                                    <p class="mt">Sales Inquiry :
                                        {{ $products[$i]->sales_inquiry == 1 ? 'Yes' : 'No' }}</p>
                                </div>
