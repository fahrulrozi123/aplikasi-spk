                    ...
                    <div class="panel-body shadow" style="display: block;">
                        <div class="col-md-12">
                            ...
                            <div class="preview-images-zone">
                                @if (isset($product))
                                    @php $n = 0; @endphp
                                    @foreach ($product_photos as $data_photo)
                                        @php $n++; @endphp
                                        <div class="preview-image preview-show-{{ $n }}">
                                            <input type="hidden" name="oldImg[]"
                                                value="{{ $data_photo->product_photo_path }}">
                ...
                <div class="panel panel-primary panel-collapsed">
                    ...
                    <div class="panel-body shadow" style="display: block;">
                        ...
                        <div class="col-xs-8 col-lg-4 {{ $sales_class }}" id="input-group">
                            <label for="product_detail" class="col-md-12" style="padding-left:0px;">
                                Package/Product Price (Pax)
                            </label>
                ...
                <div class="pull-right">
                    ...
                    @else
                        ...
                        <button type="button" onclick="confirmBox(this)"
                            class="btn btn-horison-gold btn-padding">Save</button>
                    @endif
                </div>
            </form>
        </div>
