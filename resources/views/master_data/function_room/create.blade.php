                                        ...
                                        <div class="row fr-icon-box" align="center">
                                            ...
                                            <div class="col-xs-9 col-sm-9 input-box">
                                                <input type="text" class="form-control numberValidation"
                                                    ...
                                                    value="{{ old('func_class', $func_class) }}" id="func_class"
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" style="margin-top: 20px;">
                                        <div class="row fr-icon-box" align="center">
                                            ...
                                            <div class="col-xs-9 col-sm-9 input-box">
                                                <input type="text" class="form-control numberValidation"
                                                    oninput="ambilRupiah(this);"
                                                    value="{{ old('func_board', $func_board) }}" id="func_board"
                                                    placeholder="0" autocomplete="off" required>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" style="margin-top: 20px;">
                                        <div class="row fr-icon-box" align="center">
                                            ...
                                            <div class="col-xs-9 col-sm-9 input-box">
                                                <input type="text" class="form-control numberValidation"
                                                    oninput="ambilRupiah(this);"
                                                    value="{{ old('func_round', $func_round) }}" id="func_round"
                                                    placeholder="0" autocomplete="off" required>
                                        ...
                                        <div class="row fr-icon-box" align="center">
                                            ...
                                            <div class="col-xs-9 col-sm-9 input-box">
                                                <input oninput="ambilRupiah(this);" type="text" class="form-control"
                                                    value="{{ old('func_dimension', $func_dimension) }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="preview-images-zone">
                                    @if (isset($function_room))
                                        @php $n = 0; @endphp
                                        @foreach ($function_room['photos'] as $data_photo)
                                            @php $n++; @endphp
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div style="overflow-x:auto;">
                                    <table id="table_partition"
                                        class="table table-bordered responsive {{ $table_class }}">
                                        <thead>
                                            <tr>
                                                    ...
                                                    <tr id="partition_row_{{ $no }}">
                                                        ...
                                                        <td class="fr-modal-table-content">
                                                            <input oninput="check_dimension(this);" type="text"
                                                                ...
                                                                name="partition[{{ $no }}][partition_dimension]"
                                                        ...
                                                        <td class="fr-modal-table-content">
                                                            <input oninput="numberVal(this);" type="text"
                                                                ...
                                                                name="partition[{{ $no }}][partition_class]"
                                                                id="" placeholder="" required="">
                                                        </td>
                                                        <td class="fr-modal-table-content">
                                                            <input oninput="numberVal(this);" type="text"
                                                                ...
                                                                name="partition[{{ $no }}][partition_theatre]"
                                                                id="" placeholder="" required="">
                                                        </td>
                                                        <td class="fr-modal-table-content"><input oninput="numberVal(this);"
                                                                ...
                                                                name="partition[{{ $no }}][partition_ushape]"
                                                                id="" placeholder="" required="">
                                                        </td>
                                                        <td class="fr-modal-table-content"><input oninput="numberVal(this);"
                                                                type="text" class="form-control numberValidation"
                                                                value="{{ $partition->func_board }}"
                                                                name="partition[{{ $no }}][partition_board]"
                                                                id="" placeholder="" required=""></td>
                                                        <td class="fr-modal-table-content"><input oninput="numberVal(this);"
                                                                type="text" class="form-control numberValidation"
                                                                value="{{ $partition->func_round }}"
                                                                name="partition[{{ $no }}][partition_round]"
                                                                id="" placeholder="" required=""></td>
                                                        <td class="fr-modal-table-content"><button
                                                                onclick="remove_partition({{ $no }});"
    ...
    <script>
        ...
        function add_partition() {
            ...
            var html = '<tr id="partition_row_' + partition_total + '"+num>' +
                ...
                '<td class="fr-modal-table-content">' +
                '<input type="text" class="form-control" value="" name="partition[' + partition_total +
                '][partition_name]" id="" placeholder="" required></td>' +
                '<td class="fr-modal-table-content">' +
                '<input oninput="check_dimension(this);" type="text" class="form-control partition_dimension numberValidation" value="" name="partition[' +
                partition_total + '][partition_dimension]" id="" placeholder="" required></td>' +
                '<td class="fr-modal-table-content">' +
                '<input type="text" class="form-control" oninput="numberVal(this);" value="" name="partition[' +
                partition_total + '][partition_class]"' +
                'id="" placeholder="" required>' +
                '</td>' +
                '<td class="fr-modal-table-content">' +
                '<input type="text" class="form-control " oninput="numberVal(this);" value="" name="partition[' +
                partition_total + '][partition_theatre]"' +
                'id="" placeholder="" required>' +
                '</td>' +
                '<td class="fr-modal-table-content">' +
                '<input type="text" class="form-control " oninput="numberVal(this);" value="" name="partition[' +
                partition_total + '][partition_ushape]"' +
                'id="" placeholder="" required>' +
                '</td>' +
                '<td class="fr-modal-table-content">' +
                '<input type="text" class="form-control " oninput="numberVal(this);" value="" name="partition[' +
                partition_total + '][partition_board]"' +
                'id="" placeholder="" required>' +
                '</td>' +
                '<td class="fr-modal-table-content">' +
                '<input type="text" class="form-control " oninput="numberVal(this);" value="" name="partition[' +
                partition_total + '][partition_round]"' +
                'id="" placeholder="" required>' +
                '</td>' +
                '<td class="fr-modal-table-content">' +
