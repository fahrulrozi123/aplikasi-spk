                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <label for="field-1" class="col-sm-4 control-label fr-label">Functional Room Name<br><small
                                        class="text-muted"></small></label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control " value="" name="fr_name"
                                        id="" placeholder="Input Functional Room Name">
                                </div>
                            </div><br>
                            <div class="row">
                                <label for="field-1" class="col-sm-4 control-label fr-label">Function Room Description<br><small
                                        class="text-muted"></small></label>
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                <label for="field-1" class="col-sm-4 control-label fr-label">Function Room Photos<br><small
                                        class="text-muted"></small></label>
                    ...
                    <div class="row">
                        ...
                        <a href="#"><p style="color:#D4B580;">+ Create Partition</p></a>
                        ...
                        <table class="table table-bordered responsive">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td class="fr-modal-table-content">
                                    <input type="text" class="form-control" value="" name="class_room"
                                    id="" placeholder="">
                                </td>
                                <td class="fr-modal-table-content">
                                    <input type="text" class="form-control" value="" name="theatre"
                                    id="" placeholder="">
                                </td>
                                <td class="fr-modal-table-content">
                                    <input type="text" class="form-control" value="" name="ushape"
                                    id="" placeholder="">
                                </td>
                                <td class="fr-modal-table-content">
                                    <input type="text" class="form-control" value="" name="board_room"
                                    id="" placeholder="">
                                </td>
                                <td class="fr-modal-table-content">
                                    <input type="text" class="form-control" value="" name="round_table"
                                    id="" placeholder="">
                                </td>
                                <td class="fr-modal-table-content">
                        ...
                        <a href="#"><p style="color:#D4B580;">+ Add Function Room Partition</p></a>
