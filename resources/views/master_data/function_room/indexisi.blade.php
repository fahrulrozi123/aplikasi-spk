...
<div class="col-lg-12">
    ...
    <input id="function_rooms" type="hidden" value='@json($function_rooms)'>
        @php $no = 0; @endphp
        @foreach($function_rooms as $function_room)@php $no++; @endphp
        @php
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-md-4"> {{-- fr pax total --}}
                                        <p class="fr-pax"><script>document.write(formatRupiah("{{$function_room->func_class}}"));</script> Pax</p>
                                    </div>
                                </div>
                                <div class="row" style="margin-top:10px;">
                                    ...
                                    <div class="col-xs-4 col-md-4"> {{-- fr pax total --}}
                                        <p class="fr-pax"><script>document.write(formatRupiah("{{$function_room->func_theatre}}"));</script> Pax</p>
                                    </div>
                                </div>
                                <div class="row" style="margin-top:10px; margin-bottom:10px;">
                                    ...
                                    <div class="col-xs-4 col-md-4"> {{-- fr pax total --}}
                                        <p class="fr-pax"><script>document.write(formatRupiah("{{$function_room->func_ushape}}"));</script> Pax</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-md-4"> {{-- fr pax total --}}
                                        <p class="fr-pax"><script>document.write(formatRupiah("{{$function_room->func_board}}"));</script> Pax</p>
                                    </div>
                                </div>
                                <div class="row" style="margin-top:10px;">
                                    <div class="col-xs-3 col-md-3"> {{-- icon --}}
                                    ...
                                    <div class="col-xs-4 col-md-4"> {{-- fr pax total --}}
                                        <p class="fr-pax"><script>document.write(formatRupiah("{{$function_room->func_round}}"));</script> Pax</p>
                                    </div>
                                </div>
                                <div class="row" style="margin-top:10px; margin-bottom:10px;">
                                    <div class="col-xs-3 col-md-3"> {{-- icon --}}
                                    ...
                                    <div class="col-xs-4 col-md-4"> {{-- fr pax total --}}
                                        <p class="fr-pax"><script>document.write(formatRupiah("{{$function_room->func_dimension}}"));</script> Sqm</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="javascript:;" onclick="show_modal({{($no-1)}});">
                            <p class="fr-link-text2" align="right">See {{$function_room->func_name}} Layout Details<span class="entypo-right-open"></span></p>
                        </a>
                        @endif
                    </div>
