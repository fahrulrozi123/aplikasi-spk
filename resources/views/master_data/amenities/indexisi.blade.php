                        ...
                        <div class="col-lg-3 pb">
                            <div class="input-group">
                                ...
                                <div class="input-group-btn pl">
                                    ...
                                    <input type="hidden" id="input1" name="amenities_icon[]" value="{{$stock}}" />
                                </div>
                            </div>
                        </div>
                        @endif
...
<script>
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) {
            ...
            $(wrapper).append(
                "<div class='col-lg-3 pb'><div class='input-group'><span class='input-group-addon nb' style='width: 40px;min-width: 24px;'><img id = 'icon"+x+"' src='{{$path.$stock}}' style='height:17px;width:17px;'>"+
                "</span><input id='amenities_"+x+"' type='hidden' name='amenities_id[]' value='X'><input type='text' name='amenities_name[]' class='form-control' aria-label='Text input with multiple buttons' maxlength='30' required><input id='amenities_" +
                x +"' type='hidden' name='amenities_status[]' value='3'><input type='hidden' id='input" +
                x +"' name='amenities_icon[]' value ='{{$stock}}' /><div class='input-group-btn pl'><button type='button' onclick='passData(\"{{$stock}}\", \""+x+"\");'  class='btn btn-amenities gray' id='" +
                x +"' aria-label='Help'><span class='fa fa-search'></span></button></div><div class='input-group-btn pl'><button type='button'  onclick='' class='btn btn-amenities red remove_field'><span class='fa fa-trash'></button></div></div></div>"
                ); //add input box
        });
