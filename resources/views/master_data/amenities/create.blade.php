                    ...
                    <div class="panel-body shadow">
                                ...
                                @foreach ($amenitiess as $amenities)
                                    ...
                                    <div class="col-lg-3 pb">
                                        <div class="input-group">
                                            <span class="input-group-addon nb"><i id="icon{{ $no }}"
                                                    class="fa-fw {{ $amenities->amenities_icon }}"></i></span>
                                            ...
                                            <div class="input-group-btn pl">
                                                <button onclick="passData(this);" id="{{ $no }}" type="button"
                            ...
                            @else
                                <div class="col-lg-3 pb">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="amenities_name[]" class="form-control"
                                            aria-label="Text input with multiple buttons" required>
                                        <div class="input-group-btn pl">
                        ...
                        <div class="col-lg-3">
                            <a class="add_field_button" href="#">
                                <h5 style="color:#D4B580">+ Add New Amenities</h5>
                            </a>
                        </div>
                        <div class="col-lg-12">
                            <br>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(add_button).click(function(e) {
                ...
                $(wrapper).append(
                    "<div class='col-lg-3 pb'><div class='input-group'><span class='input-group-addon nb'><i class='fa fa-wifi' id='icon" +
                    x +
                    "'></i></span><input type='text' name='amenities_name[]' class='form-control' aria-label='Text input with multiple buttons' required><input type='hidden' id='input" +
                    x +
                    "' name='amenities_icon[]' value ='fa fa-wifi' /><div class='input-group-btn pl'><button type='button' onclick='passData(this);'  class='btn btn-amenities gray' id='" +
                    x +
