    ...
    <div class="row">
        <div class="col-sm-8">
            <div class="form-group">
                <label for="field-1" class="control-label"><h5><b>NEWS TITLE</b></h5></label>
                <input type="text" class="form-control input-lg" name="post_title" placeholder="Our Latest Event, Described!" />
            </div>
        </div>
            ...
            <div class="panel panel-primary panel-shadow" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail" style="max-width: 450px; max-height: 250px;" data-trigger="fileinput">
                        ...
                        <div>
                            <span class="btn btn-file">
                                <span class="btn btn-blue fileinput-new"><i class="entypo-upload"></i> Browse File</span>
            ...
            <div class="panel panel-primary panel-shadow" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control datepicker" value="Wed, 04 Feb 2020" data-format="D, dd MM yyyy">
