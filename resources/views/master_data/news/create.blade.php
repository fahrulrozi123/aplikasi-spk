...
<form method="POST" action="{{ route('news.insert') }}" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            {{-- <div class="col-sm-6 post-save-changes"> --}}
            @if($id != "")
            ...
            <div class="col-sm-8">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-lg" name="news_title"
                        placeholder="Our Latest Event, Described!" maxlength="50" value="{{old('news_title', $news_title)}}" required/>
                    @error('news_title')
                        ...
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            ...
                            <div>
                                <span class="btn btn-file">
                                    <span class="btn btn-horison-gold shadow fileinput-new"><i class="entypo-upload"></i> Browse
                                        File</span>
                                    <span class="btn btn-white fileinput-exists">Change</span>
                                    <input type="file" name="img" accept="image/*" class="validateImage" onchange="fileValidation();">
                                </span>
            ...
            <div class="col-sm-3">
                ...
                <div class="panel-heading shadow">
                    ...
                    <div class="checkbox checkbox-replace color-primary">
                        <input name="news_pin_state" type="checkbox" onclick="check('hide',this);" id="chk-pin" {{$news_sticky_state}}>
                        <label>Pin this news</label><br>
                        <label style="padding-left:0px; font-size:11px; color:#858585">Only 1 (one) News can be Pinned</label>
                    </div><br>

                    <div class="checkbox checkbox-replace color-primary">
                        <input name="news_hide_state" onclick="check('pin',this);" type="checkbox" id="chk-hide" {{$news_publish_status}}>
                        <label>Hide this news</label><br>
                        <label style="padding-left:0px; font-size:11px; color:#858585">News won't be showed</label>
                    </div>


                    <p><b>Publish Date</b></p>
                    <div class="input-group">
                        <input type="text" id="news_publish_date" name="news_publish_date" class="form-control" value="{{$news_publish_date}}"
                        data-format="yyyy/mm/dd" style ="background-color: #FFFFFF" readonly>
