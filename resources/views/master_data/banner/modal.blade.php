            ...
            <form  method="POST"  action="{{ route('banner.insert') }}" enctype="multipart/form-data">
                ...
                <div class="fileinput fileinput-new" data-provides="fileinput"><input type="hidden">
                    <div class="fileinput-new thumbnail"  data-trigger="fileinput">
                        <img src="{{asset('/images/dashboard/insert-here2.png')}}" class="shadow" height="100" alt="image">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <span class="btn btn-file">
                                <span class="btn btn-horison-gold fileinput-new"><i class='glyphicon glyphicon-circle-arrow-up'></i> Browse File</span>
                                <span class="btn btn-cancel fileinput-exists">Change</span>
                                <input type="file" name="img" accept="image/*" id="img" class="validateImage" onchange="fileValidation();">
                            </span>
                ...
                <div class="fileinput fileinput-new" data-provides="fileinput"><input type="hidden">
                    ...
                    <div>
                        <span class="btn btn-info btn-file">
                            <span class="fileinput-new"><i class='glyphicon glyphicon-circle-arrow-up'></i> Browse File</span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="hidden" id="id-data" />
                <button type="button" onclick="if(confirm('Are you sure?')) setBanner('delete');" class="btn btn-delete btn-lg delete-modal" >Delete</button>
                <a class="btn btn-cancel btn-lg" data-dismiss="modal" href="#"> Cancel </a>
                <button type="button" onclick="if(confirm('Are you sure?')) setBanner('update');" class="btn btn-horison-gold btn-lg " >Save</button>
            </div>
        </div>
    </div>
</div>
