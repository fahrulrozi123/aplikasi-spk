                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="col-sm-5" style="margin-top:20px;">
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <div class="fileinput-new avatar-img shadow" data-trigger="fileinput"
                                                    ...
                                                    @if ($img != null)
                                                        <img src="{{ asset('/user/' . $img) }}" alt="Profile"
                                                            class="avatar-img">
                                                    @endif
                                                    @if ($img == '')
                                                        <img src="{{ asset('images/dashboard/insert-here.png') }}"
                                                            alt="Insert Here" class="avatar-img">
                                                    @endif
                                                </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control " maxLength="20"
                                                value="{{ old('name', $name) }}" name="name" id="profile_name"
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="email" class="form-control " maxLength="100" name="email"
                                                value="{{ old('email', $email) }}" id="email_address"
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control numberValidation" maxLength="20"
                                                name="phone" value="{{ old('phone', $phone) }}" id="phone_number"
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control " maxLength="20" name="username"
                                                value="{{ old('username', $username) }}" id="username"
                                                placeholder="Username" pattern="^\S+$"
                                                title="Spaces not allowed in Username." required>
                                            @error('username')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div id="change-password" class="">
                                            <div class="container">
                                                <label for="field-1" class="col-sm-2 control-label">Password<br><small
                                                        class="text-muted"></small></label>
                                                <label class="col-sm-2 control-label" id="change_password"><a
                                                        style="color:#1B729E;" onclick="showPassword();">Change
                                                        Password</a></label>
                                            ...
                                            <br>
                                            <div class="container">
                                                <label for="field-1" class="col-sm-2 control-label hidden"
                                                    id="label_pw_confirm">Verify
