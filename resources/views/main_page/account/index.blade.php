...
@section('content')
    <div class="col-lg-12">
        <div class="row">
            ...
            <a href="/main_page/account/create" class="btn btn-lg btn-horison pull-right">
                <b>+ REGISTER USER</b>
            </a>
                                ...
                                <table class="table table-striped table-bordered datatable" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($users as $user)
                                            <?php $no++; ?>
                                            <tr class="horisontd">
                                                <td style="vertical-align:middle" align="center">{{ $user->username }}
                                                </td>
                                                ...
                                                <td style="vertical-align:middle" align="center">{{ $user->last_login }}
                                                </td>
