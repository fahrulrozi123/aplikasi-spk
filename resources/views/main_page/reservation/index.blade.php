                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        <ul class="nav nav-tabs nav-horison">
                            <li class="active">
                                <a href="#profile-1" data-toggle="tab">Room Reservation</a>
                            </li>
                            <li>
                                <a href="#profile-2" data-toggle="tab">Package / Product</a>
                            </li>
                            <li>
                                <a href="#profile-3" data-toggle="tab">Inquiry</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="panel panel-primary" data-collapsed="0">
                                ...
                                <div class="panel-heading shadow">
                                    <div class="panel-title">
                                        <h4>
                                            <strong>All Reservation Status</strong>
                                        </h4>
                                    </div>
                                    <div class="panel-options">
                                        ...
                                        <a href="#" onclick='reload_data("table-2");' data-rel="reload">
                                ...
                                <div class="panel-body table-responsive shadow">
                                    <table class="table table-striped table-bordered datatable hoverTable" id="table-2">
                                        ...
                                        <tbody class="all_reservation"></tbody>
                                        <tfoot>
                                            <tr>
                        ...
                        <div class="tab-pane" id="profile-2">
                            <div class="panel panel-horison" data-collapsed="0">
                                ...
                                <div class="panel-heading">
                                    <div class="panel-title white">
                                        <h4>
                                            <strong>Package / Product Reservation Today</strong>
                                        </h4>
                                        <p id="product_today_guest">{{ $product_today }} Customer Reservation Package
                                            Today
                                        </p>
                                    </div>
                                    <div class="panel-options">
                                        ...
                                        <a href="#" onclick='reload_data("table-3");' data-rel="reload">
                                            <i class="entypo-arrows-ccw"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-primary " data-collapsed="0">
                                ...
                                <div class="panel-heading shadow">
                                    <div class="panel-title">
                                        <h4>
                                            <strong>Online Package / Product Reservation Status</strong>
                                        </h4>
                                    </div>
                                    <div class="panel-options">
                                        <a href="#" data-rel="collapse">
                                        ...
                                        <a href="#" onclick='reload_data("table-4");' data-rel="reload">
                                            <i class="entypo-arrows-ccw"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-horison" data-collapsed="0">
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="panel-options">
                                        ...
                                        <a href="#" onclick='reload_data("table-5");' data-rel="reload">
                                            <i class="entypo-arrows-ccw"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-primary " data-collapsed="0">
                                ...
                                <div class="panel-heading shadow">
                                    ...
                                    <div class="panel-options">
                                        ...
                                        <a href="#" onclick='reload_data("table-6");' data-rel="reload">
                                            <i class="entypo-arrows-ccw"></i>
                                        </a>
                                    </div>
                                </div>
        ...
        jQuery(document).ready(function($) {
            ...
            $('#table-2 tbody').on('click', 'tr', function() {
                ...
                var day = '<li>Allotment on <b>' + checkin + '</b> will be hold until the next day.</li>' +
                    ...
                    '<li>Sales that reported are Sales that only occured on <b>' + checkin +
                    '</b> counted as <b>Cancellation Fee.</b></li>' +
                    '<li>This action cannot be undone.</li>';
                // stay 2 day
                var twoday = '<li>Allotment on <b>' + checkin +
                    '</b> will be hold until the next day.</li>' +
                    '<li>Allotment on <b>' + checkout + '</b> will be returned.</li>' +
                    '<li>Sales that reported are Sales that only occured on <b>' + checkin +
                    '</b> counted as <b>Cancellation Fee.</b></li>' +
                    '<li>This action cannot be undone.</li>';
                // stay > 2 day
                var threeday = '<li>Allotment on <b>' + checkin +
                    '</b> will be hold until the next day.</li>' +
                ...
                // today (100%)
                if (data.rsvp_status == "Payment received" && new Date(checkin).getTime() == new Date(today)
                    .getTime()) {
                ...
                // one day (50%)
                else if (data.rsvp_status == "Payment received" && new Date(checkin).getTime() == new Date(
                        one_day_add).getTime()) {
                    $('#room_cancel_reschedule_btn').fadeIn();
                    $('#modal_reservation_id').val(data.reservation_id);
                    $('#modal_booking_id').val(data.booking_id);
            ...
            $('#table-4 tbody').on('click', 'tr', function() {
                ...
                if (data.rsvp_status == "Payment received") {
                    ...
                    if (data['payment'].transaction_status == "settlement") {
                        ...
                        var payment_date = moment(new Date(data['payment'].transaction_time)).format(
                            'LLLL');
                    }
                } else if (data.rsvp_status == "Waiting for payment") {
                    var paid_amount = formatRupiah(0);
