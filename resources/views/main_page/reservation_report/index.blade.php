...
@section('content')
    ...
    {{-- FOR EXPORT PURPOSE --}}
    <form id="reservation_export_excel" action="{{ route('reservation.reservation_export_excel') }}" method="post"
        target="_blank">
        {{ csrf_field() }}
    </form>
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        <ul class="nav nav-tabs nav-horison">
                            <li class="active">
                                <a href="#room" data-toggle="tab">Room Reservation</a>
                            </li>
                            <li>
                                <a href="#package" data-toggle="tab">Package / Product</a>
                            </li>
                            <li>
                                <a href="#inquiry" data-toggle="tab">Inquiry</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="panel panel-primary" data-collapsed="0">
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="panel-options">
                                        ...
                                        <a href="#" onclick='reload_data("table-1");' data-rel="reload">
