                ...
                year['data'].forEach(month => {
                    ...
                    month['data'].forEach(room => {
                        ...
                        room['data'].forEach(function(allotment, index) {
                            ...
                            array_data[yearIndex]['data'][monthIndex]['data'][roomIndex][
                                'data'
                            ][index] = allotment['remaining'];
                            array_data[yearIndex]['data'][monthIndex][
                                'opening_allotment'
                            ] += parseInt(allotment['opening']);
                            array_data[yearIndex]['data'][monthIndex][
                                'remaining_allotment'
                            ] += parseInt(allotment['remaining']);
                        });
                        roomIndex++;
                    });
                    monthIndex++;
