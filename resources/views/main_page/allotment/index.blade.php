                        ...
                        <div class="col-lg-3 col-sm-6 col-xs-12">
                            <div class="category contain" id="{{ $first_room }}" value="room_{{ $room->id }}"
                                ...
                                <a>
                                    ...
                                    <div class="centered">
                                        <h2 class="white-shadow" style="margin-top:75px;">
            ...
            if (no == "") {
                ...
                for (i = 0; i <= days; i++) {
                    ...
                    if (new Date(startDate) < new Date(today)) {
                        ...
                        var msg = "Sorry for allotment in Date: " + moment(dayDate).format('DD MMMM YYYY') +
                            " cannot be less than " + total_reservation;
                        alert(msg);
                        check = false;
                        break;
                    }
                        ...
                        if (data['allotment'].length > 0) {
                            data['allotment'].some(function(allotment, index) {
                                if (allotment.allotment_date == startDate) {
                                    ...
                                    $('#remaining_allotment').val(formatRibuan(allotment
                                        .remaining_allotment));
                                    $('#room_publish_rate').val(formatRibuan(allotment
