...
@section("header_title") SALES REPORT @endsection
@section('content')
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control borderlight" id="report_period"
            ...
            <div class="col-sm-12">
                <div class="panel panel-primary panel-shadow" data-collapsed="0">
                    ...
                    <div class="panel-body shadow">
                        ...
                        <h3><b>MOST RESERVED ROOMS & PACKAGE</b></h3>
                        ...
                        <div id="cek_room_sales" class="panel panel-primary" data-collapsed="0">
                            ...
                            <div class="panel-heading">
                                <div class="panel-title">
                                    <h4><strong>ROOM SALES</strong></h4>
                                </div>
                                <div class="panel-options">
                                    {{-- <a href="#sample-modal" data-toggle="modal" data-target="#sample-modal-dialog-1"><i class="entypo-cog"></i></a> --}}
                                    <a id="btn_room_sales" href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                            ...
                            <div class="panel-body no-padding">
                                <div style="overflow-x:auto;">
                                    <table class="table table-striped table-bordered datatable" id="table-room_reservation">
                                        <thead>
                                            <tr>
                        ...
                        <div id="cek_package_sales" class="panel panel-primary" data-collapsed="0">
                            ...
                            <div class="panel-heading">
                                <div class="panel-title">
                                    <h4><strong>PACKAGE SALES</strong></h4>
                                </div>
                                <div class="panel-options">
                                    {{-- <a href="#sample-modal" data-toggle="modal" data-target="#sample-modal-dialog-1"><i class="entypo-cog"></i></a> --}}
                                    <a id="btn_package_sales" href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                                    {{-- <a href="#" data-rel="reload" class="bg"><i class="entypo-arrows-ccw"></i></a> --}}
                                </div>
                            </div>
                            ...
                            <div class="panel-body no-padding">
                                <div style="overflow-x:auto;">
                                    <table class="table table-striped table-bordered datatable" id="table-product_reservation">
                                        <thead>
                                            <tr>
            ...
            <div class="col-sm-12">
                <div id="cek_all_room" class="panel panel-primary panel-shadow" data-collapsed="0">
                    ...
                    <div class="panel-heading shadow">
                        ...
                        <div class="panel-title">
                            <h2><b>ALL ROOMS RESERVATION</b></h2>
                        </div>
                        <div class="panel-options">
                            {{-- <a href="#sample-modal" data-toggle="modal" data-target="#sample-modal-dialog-1"><i class="entypo-cog"></i></a> --}}
                            <a id="btn_all_room" href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                            {{-- <a href="#" data-rel="reload" class="bg"><i class="entypo-arrows-ccw"></i></a> --}}
                        </div>
                    ...
                    <div class="panel-body shadow">
                        ...
                        <div class="box-custreport shadow">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <h5 style="margin-bottom: 0%; color:silver"><b>NETT SALES</b></h5>
                                    <h3 style="margin-top: 3%; color:seagreen"><b id="room_nett_sales">Rp 45,000,000</b></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-primary" data-collapsed="0">
                            ...
                            <div class="panel-body no-padding">
                                <div style="overflow-x:auto;">
                                    <table class="table table-striped table-bordered datatable" id="table-room_reservation_all">
                                        <thead>
                                            <tr>
            ...
            <div class="col-sm-12">
                <div id="cek_all_package" class="panel panel-primary panel-shadow" data-collapsed="0">
                    ...
                    <div class="panel-heading shadow">
                        ...
                        <div class="panel-title">
                            <h2><b>ALL PACKAGE RESERVATION</b></h2>
                        </div>
                        <div class="panel-options">
                            {{-- <a href="#sample-modal" data-toggle="modal" data-target="#sample-modal-dialog-1"><i class="entypo-cog"></i></a> --}}
                            <a id="btn_all_package" href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                            {{-- <a href="#" data-rel="reload" class="bg"><i class="entypo-arrows-ccw"></i></a> --}}
                        </div>
                    ...
                    <div class="panel-body shadow">
                        ...
                        <div class="box-custreport shadow">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <h5 style="margin-bottom: 0%; color:silver"><b>NETT SALES</b></h5>
                                    <h3 style="margin-top: 3%; color:seagreen"><b id="product_nett_sales">Rp 13,500,000</b></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-primary" data-collapsed="0">
                            ...
                            <div class="panel-body no-padding">
                                <div style="overflow-x:auto;">
                                    <table class="table table-striped table-bordered datatable" id="table-product_reservation_all">
                                        <thead>
                                            <tr>
...
<script type="text/javascript">
    ...
    function set_all_data() {
        ...
        room_data['room'].forEach(element => {
            room_reservation.push([element.room_type, formatRibuan(element.total_room_sales ?? 0), formatRupiah(element.average_rate ?? 0), formatRupiah(element.room_revenue ?? 0),
                                    formatRupiah(element.tax_collected ?? 0), formatRupiah(element.service_collected ?? 0), formatRupiah(element.nett_sales ?? 0)
            ]);
        });
        ...
        product_data['product'].forEach(element => {
            ...
            formatRupiah(element.average_rate ?? 0), formatRupiah(element.product_revenue ?? 0), formatRupiah(element.tax_collected ?? 0)
            , formatRupiah(element.service_collected ?? 0), formatRupiah(element.nett_sales ?? 0)]);
        });
        ...
        product_data['rsvp'].forEach(element => {
            product_reservation_all.push([element.product_name, formatRibuan(element.rsvp_amount_pax), formatRupiah(element.rsvp_pax_price),
                                    formatRupiah(element.rsvp_grand_total), formatRupiah(element.rsvp_tax),
       ...
       product_data['product'].forEach(element => {
        ...
        for (let i = 0; i < product_chart_data.length; i++) {
            if (i > 3 && product_chart_data[i] != undefined) {
                ...
                product_chart_data[3].total = parseInt(product_chart_data[3].total) + parseInt(product_chart_data[i].total);
        ...
        total_transaction = parseInt(room_data['total_transaction'] ?? 0) + parseInt(product_data['total_transaction'] ?? 0);
    ...
    function savePDF() {
        ...
        if(checkbox_report[0].checked == false && checkbox_report[1].checked == false
            && checkbox_report[2].checked == false && checkbox_report[3].checked == false && checkbox_report[4].checked == false){
                Swal.fire({
                        icon: 'warning',
                        title: 'warning',
        ...
        var roomData = [
            [
                { text: 'Room Type', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 6, 0, 6] },
                { text: 'Sold', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Average Rate', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Room Revenue', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Tax Collected', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Services Collected', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Nett Sales', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] }
            ]
        ];
        var productData = [
            [
                { text: 'Package Name', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 6, 0, 6] },
                { text: 'Sold', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Average Rate', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Package Revenue', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Tax Collected', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Services Collected', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Nett Sales', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] }
            ]
        ...
        var room_sales_report = [
            [
                { text: 'Date', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 6, 0, 6] },
                { text: 'Reserved Rooms', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'ADR', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Room Revenue', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Tax Collected', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Services Collected', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Nett Revenue', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] }
            ]
        ];

        var product_sales_report = [
            [
                { text: 'Reserved Package', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 6, 0, 6] },
                { text: 'Quantity', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Price', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Revenue', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Tax Collected', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Services Collected', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] },
                { text: 'Nett Revenue', bold: true, fontSize: 9, fillColor: '#F2F2F2', alignment: 'center', margin: [0, 5, 0, 5] }
            ]
        ...
        room_reservation.forEach(function (sourceRow) {
            var dataRow =
            [
                { text: sourceRow[0], fontSize: 9, alignment: 'center', margin: [0, 6, 0, 6] },
                { text: sourceRow[1], fontSize: 9, alignment: 'center', margin: [0, 5, 0, 5] },
                { text: sourceRow[2], fontSize: 9, alignment: 'center', margin: [0, 6, 0, 6] },
                { text: sourceRow[3], fontSize: 9, alignment: 'center', margin: [0, 6, 0, 6] },
                { text: sourceRow[4], fontSize: 9, alignment: 'center', margin: [0, 6, 0, 6] },
                { text: sourceRow[5],fontSize: 9, alignment: 'center', margin: [0, 6, 0, 6] },
                { text: sourceRow[6],fontSize: 9, alignment: 'center', margin: [0, 6, 0, 6] }
            ];
        ...
        Promise.all([
                    ...
                    columns: [
                        ...
                        },
                        {
                            stack: [
                                ...
                                { text: 'HORISON SALES REPORT', fontSize: 17, bold: true, color: '#333333', margin: [0, 5, 0, 3] },
                                { text: "Report Period: "+period+"", fontSize: 10, color: '#333333' },
                            ],
                        },
                    ],
            ...
            if(checkbox_report[0].checked == true){
                ...
                doc.content.push({
                    columns: [
                        {
                            stack: [
                                    { text: 'TOTAL TRANSACTION', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 0, 0, 5] },
                                    { text: formatRibuan(total_transaction), fontSize: 14, bold: true, color: '#333333' },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'ROOM RESERVATION', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 0, 0, 5] },
                                    { text: formatRibuan(total_room_reservation), fontSize: 14, bold: true, color: '#333333' },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'PACKAGE RESERVATION', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 0, 0, 5] },
                                    { text: formatRibuan(total_product_reservation), fontSize: 14, bold: true, color: '#333333' },
                            ],
                        width: 'auto',
                        }
                    ],
                ...
                doc.content.push({
                    columns: [
                        {
                            stack: [
                                    { text: 'GROSS SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 13, 0, 5] },
                                    { text: formatRupiah(total_gross_sales), fontSize: 14, bold: true, color: '#333333' },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'SERVICE SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 13, 0, 5] },
                                    { text: formatRupiah(total_service), fontSize: 14, bold: true, color: '#333333' },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'TAX SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [-3, 13, 0, 5] },
                                    { text: formatRupiah(total_tax), fontSize: 14, bold: true, color: '#333333', margin: [-3, 0, 0, 0] },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'NETT SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 13, 0, 5] },
                                    { text: formatRupiah(total_nett_sales), fontSize: 14, bold: true, color: '#219653' },
                            ],
                        width: 'auto',
                        }
                    ],
            ...
            // BATAS SUCI - GENERAL //
            if(checkbox_report[0].checked == true || checkbox_report[1].checked == true && checkbox_report[2].checked == true){
                doc.content.push({
            ...
            }else if (checkbox_report[0].checked == true || checkbox_report[1].checked == false && checkbox_report[2].checked == true){
                doc.content.push({
                    text: "ALL ROOMS RESERVATION",
                    bold: true,
                    fontSize: 17,
                    ...
                    columns: [
                        {
                            stack: [
                                    { text: 'GROSS SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 13, 0, 5] },
                                    { text: formatRupiah(room_gross_sales), fontSize: 14, bold: true, color: '#333333' },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'SERVICE SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 13, 0, 5] },
                                    { text: formatRupiah(room_service_sales), fontSize: 14, bold: true, color: '#333333' },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'TAX SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [-3, 13, 0, 5] },
                                    { text: formatRupiah(room_tax_sales), fontSize: 14, bold: true, color: '#333333', margin: [-3, 0, 0, 0] },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'NETT SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 13, 0, 5] },
                                    { text: formatRupiah(room_nett_sales), fontSize: 14, bold: true, color: '#219653' },
                            ],
                        width: 'auto',
                        }
                    ],
                    ...
                    columns: [
                        {
                            stack: [
                                    { text: 'GROSS SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 13, 0, 5] },
                                    { text: formatRupiah(product_gross_sales), fontSize: 14, bold: true, color: '#333333' },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'SERVICE SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 13, 0, 5] },
                                    { text: formatRupiah(product_service_sales), fontSize: 14, bold: true, color: '#333333' },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'TAX SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [-3, 13, 0, 5] },
                                    { text: formatRupiah(product_tax_sales), fontSize: 14, bold: true, color: '#333333', margin: [-3, 0, 0, 0] },
                            ],
                        width: 'auto',
                        },
                        {
                            stack: [
                                    { text: 'NETT SALES', fontSize: 11, bold: true, color: '#C0C0C0', margin: [0, 13, 0, 5] },
                                    { text: formatRupiah(product_nett_sales), fontSize: 14, bold: true, color: '#219653' },
                            ],
                        width: 'auto',
                        }
                    ],
