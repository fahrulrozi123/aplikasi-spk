        ...
        <div class="panel panel-primary panel-collapsed">
            <div class="panel-heading shadow">
                <div class="panel-title">
                    <h4>
                        <strong>{{ $pagesetting->page_name }}</strong>
                    </h4>
                </div>
            ...
            <div class="panel-body shadow">
                <div class="row">
                    <div class="col-md-6">
                        <div class="container">
                            <label for="page_name" class="col-sm-2 control-label">Page Name<br><small
                                    class="text-muted"></small></label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="page_name" id="page_name"
                                    value="{{ $pagesetting->page_name }}" placeholder="Page Name">
                                @error('page_name')
                        ...
                        <div class="container">
                            <label for="page_description" class="col-sm-2 control-label">Page Details<br><small
                                    class="text-muted"></small></label>
                            <div class="col-sm-4">
                                <textarea name="page_description" id="page_description" cols="1" rows="4" style="" class="form-control"
                                    id="page_description"
                                    placeholder="Describe page description here">{{ old('page_description', $pagesetting->page_description) }}</textarea>
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="preview-images-zone">
                                    @if (isset($pagesetting))
                                        @php $n = 0; @endphp
                                        @foreach ($pagesetting['photo'] as $data_photo)
                                            @php $n++; @endphp
                                            <div class="preview-image preview-show-{{ $n }}">
                                                ...
                                                <div class="image-zone">
                                                    <img id="pro-img-{{ $n }}"
                                                        src="{{ asset('/user/' . $data_photo->photo_path) }}">
                                                </div>
                                            </div>
                                        @endforeach
                                    @endif
                ...
                <div class="row" align="right">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <a href="/main_page/page_setting" class="btn btn-white btn-lg shadow"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.image-cancel', function() {
                ...
                if ($(".preview-image").length > 0) {} else {
