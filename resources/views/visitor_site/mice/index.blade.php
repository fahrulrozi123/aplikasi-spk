...
@section('description', 'Mice Horison Ultima Bandung. Booking dari website kami untuk dapatkan harga terbaik!')
@section('keywords', 'Mice Horison Ultima Bandung, Mice')
@section('title', 'Mice')
            ...
            <div class="">
                ...
                <div class="row">
                                ...
                                <div class="bbaris-rec">
                                    ...
                                    @if($i <= 3) <div class="column {{$class}}" style="height:80px!important;">
                                        <img class="demo1 id_{{$no}}"
                                            ...
                                            onclick="currentSlide({{$no}}, {{$i}});" alt="Mice" loading="lazy">
                                        @if($i == 3)
                    ...
                    <section class="album-info shadow" style="height: 19rem;">
                        ...
                        <a href="/mice/{{ $mice->product_slug }}" class="font-secondary"
                            style="font-size: 11px;"><i><u>See more description</u></i></a>
                        @else
                        <h5 class="line-clamp-3" style="margin-bottom: 7px; height: 90px;">{!! $mice->product_detail !!}
                        </h5>
                        @endif
