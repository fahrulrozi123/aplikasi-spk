...
@section('description', 'Wellness Horison Ultima Bandung. Booking dari website kami untuk dapatkan harga terbaik!')
@section('keywords', 'Wellness Horison Ultima Bandung, Wellness')
