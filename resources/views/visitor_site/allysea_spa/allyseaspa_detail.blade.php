...
<div class="container">
    ...
    <ol class="breadcrumb bc-3" style="font-size:13px;">
        <li>
            <a href="/visitor/allysea_spa"><span class="entypo-left-open"></span>Back</a>
        </li>
    </ol>

    {{-- HEADER --}}
    <h1 class="mt mb title-roomsdetail" style="text-transform: uppercase;"><label>Aromatherapy</label></h1>
    <br>
