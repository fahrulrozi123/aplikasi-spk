...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(TimezZ, [{
    ...
    value: function initTimer() {
      ...
      this.element.innerHTML = '<h3><p class="text-holocene"><i class="fa fa-clock-o"></i> '+this.outputTemplate(canContinue ? countMinutes : 0, 'minutes') + this.outputTemplate(canContinue ? countSeconds : 0, 'seconds')+'</h3></p>';
